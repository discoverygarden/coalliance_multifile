...
﻿  ﻿  ﻿  ﻿  ﻿  ﻿  ﻿  ﻿  MultiFile.accept = MultiFile.accept.replace(/\W+/g,'|').replace(/^\W|\W$/g,'');
       ...
       // Add our new textfield before the multi-file uploader.
       $('#'+MultiFile.wrapID+'').prepend('<br><strong>Set file label:</strong><br><input type="text" name="multi-file-label" id="multi-file-label" size="40"/><br><div class="description">This label will display to users in the viewer.</div><br>');
...
﻿  ﻿  ﻿  ﻿  ﻿  ﻿  ﻿  ﻿  
        ...
        var
         ...
         var label = $("#multi-file-label").val();
         var pathname = window.location.pathname;
         
         // Determine where multi-file is being called from
         var match = pathname.search("ingest_files");
         
         if (match != -1) {
             var formid = '#coalliance-multifile-form';
         }
         else {
             var formid = '#coalliance-form-adapter-ingest-form'
         }
         
         // If there is a value in the label textfield we need to replace any
